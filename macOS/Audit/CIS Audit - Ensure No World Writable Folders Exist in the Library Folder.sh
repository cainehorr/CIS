...
#
#   BENCHMARK NAME:
#   CIS Audit - Ensure No World Writable Folders Exist in the Library Folder
#
...
#
#   AUDIT: 
#   Verify that no directories in the /System/Volumes/Data/Library folder are world-writable.
#
####################################################################################################
#
#   CHANGE CONTROL LOG
...
audit(){
    if (( "${os_version}" > "${maximum_macOS_version_required}" )); then
        ...
        audit_world_writable_folders_do_not_exist_in_library_folder="$(/usr/bin/sudo /usr/bin/find /System/Volumes/Data/Library -type d -perm -2 -ls 2>&1 | /usr/bin/grep -v Caches | /usr/bin/grep -v /Preferences/Audio/Data | /usr/bin/wc -l | /usr/bin/xargs)"

        if [ "${audit_world_writable_folders_do_not_exist_in_library_folder}" = "0" ]; then
